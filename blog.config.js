...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'lazy-zed', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '想一千个idea不如做一个demo', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lazy-zed.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Lazed博客,LazedBlog,记录生活,分享知识,工具,游戏开发,U3D,AI,渲染', // 网站关键词 英文逗号隔开
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://i0.hdslb.com/bfs/article/d0c41971bf01064f247571b958ab676f2795c94d.jpg@1256w_842h_!web-article-pic.avif', // blog favicon 配置, 默认使用 /favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
